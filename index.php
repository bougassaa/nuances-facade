            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="mt-3 text-secondary">
                        Facadier très professionnel. Travail sérieux et personnel agréable. Bon rapport qualité / prix.<br>Je recommande cette entreprise.
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-md-0 mb-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="mt-3 text-secondary">
                        Entreprise sérieuse, très agréable, travail de qualité, belle finition. Chantier très propre.<br>Je recommande sincèrement l’entreprise Nuances façade
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-md-0 mb-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="mt-3 text-secondary">
                        Nous avons fait appel à ce façadier pour nos clôtures et abris de jardin. Nous sommes très ravie du résultat. Professionnel très arrangeant, travail propre
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-md-0 mb-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="mt-3 text-secondary">
                        Équipe très soigneuse et sérieuse. Résultats au top ! Je suis ravie d avoir fais affaire avec Nuances Façade.<br>Délai, ponctualité, professionnalisme, tarifs.  Merci
                    </div>
                </div>
            </div>
        </div>
